...
// Levantar el servidor y luego el Túnel
app.listen(PORT, '0.0.0.0', async () => {
  ...
  try {
    const tunnel = await localtunnel({ 
      port: PORT,
      subdomain: "ticket7-demo-back" // Intentará usar este nombre siempre
    });

    console.log(`🌍 TÚNEL ACTIVO: ${tunnel.url}`);
    
    // Guardar la URL en Firestore para que el Front la encuentre
